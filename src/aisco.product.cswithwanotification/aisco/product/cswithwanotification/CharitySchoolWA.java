package aisco.product.cswithwanotification;
...
public class CharitySchoolWA {
    ...
    {  
        Donation donate = DonationFactory.createDonation("aisco.donation.wanotification.DonationImpl");
        donate.addDonation();
        donate.getDonation();
    }
